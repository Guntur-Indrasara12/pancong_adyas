                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_bahan" id="nama_bahan"
                                placeholder="Nama Bahan" value="<?= old('nama_bahan'); ?>" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control" name="harga_beli" id="harga_beli"
                                placeholder="Harga Beli" value="<?= old('harga_beli'); ?>" required min="0">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="satuan" id="satuan"
                                placeholder="Contoh: Kg, Liter, Buah" value="<?= old('satuan'); ?>" required maxlength="50">
